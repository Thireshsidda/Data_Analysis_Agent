...
def main():
    st.set_page_config(page_title="TS Data Analysis Agent", layout="wide")
    ...
    st.markdown("""
        <style>
            .stApp {
                ...
                color: #00008B; /* Dark blue for text */
            }
            .st-emotion-cache-1wv9v3w { /* Streamlit header */
                background-color: transparent;
                color: #00008B;
            }
            .st-emotion-cache-1wv9v3w h1, .st-emotion-cache-1wv9v3w h2, .st-emotion-cache-1wv9v3w h3 {
                color: #00008B;
            }
            .st-emotion-cache-79elbk { /* Chat message container */
            ...
            .st-emotion-cache-4oy390 { /* Chat message */
                 color: #00008B;
            }
            .st-emotion-cache-1g82j7s { /* User chat message */
                background-color: #F0F8FF; /* AliceBlue */
                border: 1px solid #B0E0E6; /* PowderBlue */
            }
            .st-emotion-cache-1c7y333 { /* User message container */
                 color: #00008B;
            }
            .st-emotion-cache-1vb22y7 {
                color: #00008B;
            }
            .st-emotion-cache-13vn123 {
                color: #00008B;
            }
            .stButton>button {
                color: #FFFFFF;
            ...
            .st-emotion-cache-h4y40z {
                color: #00008B;
            }
            .css-1jc7l42 { /* Title and header styling */
                color: #00008B;
            }
            .css-q8spsk { /* Subheader styling */
                color: #00008B;
            }
            .st-emotion-cache-1f81v3c { /* Main container */
                 background-color: white;
            }
            .st-emotion-cache-1v09j0h { /* Chat input */
                 background-color: white;
            }
             .st-emotion-cache-1oe2h5h { /* text box */
                 color: #00008B;
             }
        </style>
    """, unsafe_allow_html=True)
    ...
    st.markdown(
        f'<div style="text-align: right;"><img src="https://ibb.co/Ngsy4hP" alt="TS Logo" width="100"></div>',
        unsafe_allow_html=True
    )
    ...
    with left:
        st.header("TS Data Analysis Agent")
